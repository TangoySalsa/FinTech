...
namespace INS.SASWEB.AccesoDatos
{
    public class BDConexion
    {
        public System.DateTime EMPTY_DATETIME; // DateTime.Parse("0001/01/01")

        public Object GetNullSafeString(System.String value)
        {
        ...
        /// <returns></returns>
        public Object GetNullSafeEmptyString(System.String value)
        {
            return (value != null && !String.IsNullOrEmpty(value.Trim())) ? ((object)value) : (DBNull.Value);
        }

        public Object GetNullSafeDateTime(System.DateTime value)
        {
            return (value != EMPTY_DATETIME) ? ((object)value) : (DBNull.Value);
        }

        public Object GetNullSafePrimaryKey(System.Int32 value)
        {
        ...
        public Object GetNullSafePrimaryKey(Object src_object, String property_name)
        {
            Object value;
        ...
        /// <param name="target_property"></param>
        /// <returns>cuando no hay condiciones de error retorna System.Int32 o DbNull.Value</returns>
        public Object GetNullSafeZeroBasePrimaryKey(Object src_object, String property_name)
        {
            Object value;
        ...
        private Object GetPropertyValue(Object src_object, String property_name)
        {
        ...
        /// <param name="target_property"></param>
        /// <returns></returns>
        public Object GetNullSafeValue(Object src_object, String property_name)
        {
            Object value;
        ...
        public Object SetNullSafeValue(Object dst_object, String dst_property, Object dst_value)
        {
        ...
        public byte[] ReadNullSafeImage(object db_value)
        {
            if (db_value is byte[])
            {
        ...
        public System.Int32 ReadNullSafeInt(Object db_value)
        {
            return ReadNullSafeInt(db_value, 0);
        }

        public System.Int32 ReadNullSafeInt(Object db_value, int default_value)
        {
        ...
        public System.DateTime ReadNullSafeDateTime(Object db_value)
        {
            return ReadNullSafeDateTime(db_value, EMPTY_DATETIME);
        }

        public System.DateTime ReadNullSafeDateTime(Object db_value, DateTime default_value)
        {
        ...
        public System.String ReadNullSafeString(Object db_value)
        {
            return ReadNullSafeString(db_value, null);
        }

        public System.String ReadNullSafeString(Object db_value, String default_value)
        {
            if (db_value == null)
            {
                return String.Empty;
        ...
        public System.Double ReadNullSafeDouble(Object db_value)
        {
            return ReadNullSafeDouble(db_value, 0);
        }

        public System.Decimal ReadNullSafeDecimal(Object db_value)
        {
            return ReadNullSafeDecimal(db_value, 0);
        }

        public System.Double ReadNullSafeDouble(Object db_value, System.Double default_value)
        {
        ...
        public System.Decimal ReadNullSafeDecimal(Object db_value, System.Decimal default_value)
        {
            if (db_value is System.Decimal)
            {
                return (System.Decimal)db_value;
            }
            else if (db_value is System.Decimal)
            {
                System.Object casting_value = Convert.ChangeType(db_value, typeof(Decimal));
                return (System.Decimal)casting_value;
            }
            return default_value;
        }

        public float ReadNullSafeFloat(Object db_value)
        {
            return ReadNullSafeFloat(db_value, 0);
        }

        public float ReadNullSafeFloat(Object db_value, float default_value)
        {
        ...
        public System.Boolean ReadNullSafeBoolean(Object db_value)
        {
            return ReadNullSafeBoolean(db_value, false);
        }

        public System.Boolean ReadNullSafeBoolean(Object db_value, System.Boolean default_value)
        {
        ...
        //    Database dataBase;
        //    dataBase = factory.Create("SASWEBConnection");
        //    return dataBase;
        //}

        //public Database GenerarDatabaseAS400()
        //{
        //    DatabaseProviderFactory factory = new DatabaseProviderFactory();
        //    Database dataBase;
        //    dataBase = factory.Create("AS400PointGeneral");
        //    return dataBase;
        //}
    }
}
